...
async function procesarBoleta(page, boleta) {
  ...
  const boletaInput = page.locator('.window:visible label:has-text("Boleta") ~ span input.textbox-text');
  await boletaInput.click();
  await boletaInput.fill(boleta.numero);

  const apellido = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[5]/td[2]/div/span/input[1]');
  await apellido.fill(boleta.apellido);
  await page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[6]/td[2]/div/span/span').click();
  await page.locator('#_easyui_combobox_i4_2').click();
  const domicilio = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[7]/td[2]/div/p/span/input[1]');
  await domicilio.fill(boleta.domicilio);
  const nombre = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[5]/td[3]/div/span/input[1]');
  await nombre.fill(boleta.nombre);
  const dni = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[6]/td[3]/div/p/span/input[1]');
  await dni.fill(boleta.dni);
  const monto = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[19]/td[2]/div/p/span/input[1]');
  await monto.fill(boleta.monto);
  const objetoImponible = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[20]/td[2]/div/span/input[1]');
  await objetoImponible.fill(boleta.objeto);
  const oficial = page.locator('xpath=/html/body/div[11]/div[2]/form[1]/table/tbody/tr[13]/td[3]/div/span/span/a');
  await oficial.click();
  ...
  const nombreArchivo = await page.locator('input#filebox_file_id_1').evaluate(
...
export async function flujoCarga () {
  ...
  await page.locator('xpath=/html/body/center[3]/div[2]/div[2]/table/tbody/tr/td[2]/span/span/a').click();
  await page.locator('#_easyui_combobox_i1_1').click();
  await page.locator('xpath=/html/body/center[3]/div[2]/div[2]/table/tbody/tr/td[4]/span/span').click();
  await page.locator('#_easyui_combobox_i2_1').click();
  await page.locator('xpath=/html/body/center[3]/div[2]/div[2]/table/tbody/tr/td[6]/span/span').click();
